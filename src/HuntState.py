...
class HuntState():
    def __init__(self, state):
        ...
        while self.encounter_number < 5 and not self.game_over:
            print("Got through battle setup!")
            self.game_over = BattleState(self.state, isBoss=False)
            ...
            if self.game_over:
                ...
                self.state.escrow = 0
            self.state.assistant.say("You return to town. You sell the goods from your hunt for " + str(self.state.escrow) + " gold pieces!")

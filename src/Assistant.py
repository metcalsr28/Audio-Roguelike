...
class Assistant:
    ...
    def read_town_area_descriptor(self, index):
        self.say(self.state.area_descriptors[index])
    ...
    #         self.say("An {} attacks!".format(opponent.name))
    #     else:
    #         self.say("A {} attacks!".format(opponent.name))

    def explain_battle(self, opponent):
        self.say("You are targeting a: " + opponent.name)
